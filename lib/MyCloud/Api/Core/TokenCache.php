...
{
    // public static $CACHE_PATH = MCUtil::root_dir( __FILE__, 5 ) . DIRECTORY_SEPARATOR . 'token.cache';
	// UNDONE Is this the best place to store the token cache?!
    public static $CACHE_PATH = '../../../../token.cache';
    ...
    {
        $config = ($config && is_array($config)) ? $config : MCConfigManager::getInstance()->getConfigHashmap();
